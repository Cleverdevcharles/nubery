  ...
  $(function () {
    ...
    $('.custom-select').each(function () {
      ...
      template +=
        ...
        $(this).attr('title') +
        '</span>'
      template += '<div className="custom-options">'
      $(this)
        .find('option')
        .each(function () {
          template +=
      ...
      template += '</div></div>'
      $(this).wrap('<div className="custom-select-wrapper"></div>')
      $(this).hide()
      $(this).after(template)
    })
    ...
    if (filterToggle) {
      filterToggle.addEventListener('click', function () {
        ...
        var productContent = document.querySelectorAll(
    ...
    if (document.getElementById('overviewChart')) {
      var overviewChart = new ApexCharts(
    ...
    if (document.getElementById('overviewChart2')) {
      var overviewChart = new ApexCharts(
        document.querySelector('#overviewChart2'),
        {
          chart: {
            height: 340,
            type: 'area',

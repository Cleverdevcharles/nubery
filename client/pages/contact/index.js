        ...
        <form onSubmit={sendEmail} ref={form}>
          <div>
            ...
            <input className="contact-input w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text" placeholder="Your full name" name="user_name"/>
          </div>
          <div className="mt-8">
          ...
          <div className="mt-8">
            ...
            <textarea
              className="contact-input w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" 
              name="message"
              ></textarea>
          </div>
          <div className="mt-8">

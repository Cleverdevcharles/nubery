      ...
      <div className="sm:w-2/3 mx-2 sm:mx-auto grid sm:grid-cols-2 grid-rows-2 gap-3 sm-gap-1 mb-10">
        <div className="flex justify-center">
          <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
            <h5 className="text-gray-900 text-xl leading-tight font-bold mb-2 text-center">
        ...
        {/* <div className="flex justify-center">
          <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
            ...
            <button
              type="button"
              className=" inline-block px-6 py-2.5 bg-brightRedLight text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-brightRed hover:shadow-lg focus:bg-brightRed focus:shadow-lg focus:outline-none focus:ring-0 active:bg-brightRed active:shadow-lg transition duration-150 ease-in-out"
            >
...
<div className=" text-gray-100 px-8 py-12" style={{background: "#f5f7fa"}}>
      <div className="text-center w-full">
        <h1 className="h-8 mx-auto contact_title">CONTACT US</h1>
      </div>
      <div
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="text-gray-700 mt-8">
              Hate forms? Send us an <a href="mailto:nuberydotnet@gmail.com" target="_blank" className="contact_email">email</a> instead.
            </div>
          </div>
          <div className="mt-8 text-center">
            <svg className="w-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <g opacity="0.1">
                <ellipse cx="479.42" cy="362.12" rx="11.38" ry="14.9" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="##000" />
                <ellipse cx="479.42" cy="271.07" rx="11.38" ry="14.9" fill="##000" />
                <ellipse cx="479.42" cy="252.86" rx="11.38" ry="14.9" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="#ff6636" />
                <path
              ...
              <g opacity="0.1">
                <ellipse cx="612.28" cy="330.26" rx="8.51" ry="11.13" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="##000" />
                <ellipse cx="612.28" cy="262.22" rx="8.51" ry="11.13" fill="##000" />
                <ellipse cx="612.28" cy="248.61" rx="8.51" ry="11.13" fill="##000" />
                <path
              ...
              <g opacity="0.1">
                <ellipse cx="1038.58" cy="322.12" rx="11.38" ry="14.9" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="##000" />
                <ellipse cx="1038.58" cy="231.07" rx="11.38" ry="14.9" fill="##000" />
                <ellipse cx="1038.58" cy="212.86" rx="11.38" ry="14.9" fill="##000" />
                <path
              ...
              <g opacity="0.1">
                <ellipse cx="928.72" cy="324.26" rx="8.51" ry="11.13" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="##000" />
                <ellipse cx="928.72" cy="256.22" rx="8.51" ry="11.13" fill="##000" />
                <ellipse cx="928.72" cy="242.61" rx="8.51" ry="11.13" fill="##000" />
                <path
              ...
              <g opacity="0.1">
                <ellipse cx="61.59" cy="322.12" rx="11.38" ry="14.9" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="##000" />
                <ellipse cx="61.59" cy="231.07" rx="11.38" ry="14.9" fill="##000" />
                <ellipse cx="61.59" cy="212.86" rx="11.38" ry="14.9" fill="##000" />
                <path
              ...
              <g opacity="0.1">
                <ellipse cx="171.44" cy="324.26" rx="8.51" ry="11.13" fill="##000" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="##000" />
                <ellipse cx="171.44" cy="256.22" rx="8.51" ry="11.13" fill="##000" />
                <ellipse cx="171.44" cy="242.61" rx="8.51" ry="11.13" fill="##000" />
                <path
              ...
              <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#ff6636" opacity="0.1" />
              <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#ff6636" opacity="0.1" />
              <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#ff6636" opacity="0.1" />
              <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#ff6636" opacity="0.1" />
              <path
                ...
                transform="translate(-52 -162.63)" fill="#ff6636" opacity="0.1" />
              <path
              ...
              <path
                ...
                transform="translate(-52 -162.63)" opacity="0.1" />
              <circle cx="779.73" cy="238.18" r="99.96" fill="##000" />
              <path
              ...
              <path
                ...
                transform="translate(-52 -162.63)" opacity="0.1" />
              <circle cx="550.08" cy="390.01" r="99.96" fill="##000" />
              <path
              ...
              <path
                ...
                transform="translate(-52 -162.63)" opacity="0.1" />
              <circle cx="312.85" cy="315.36" r="99.96" fill="##000" />
        ...
        <div className="">
          <div>
            ...
            <input className="contact-input w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
          ...
          <div className="mt-8">
            ...
            <textarea
              className="contact-input w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
          </div>
          <div className="mt-8">
            <button
              className="uppercase text-sm font-bold tracking-wide text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline contact-btn" >
              Send Message
            </button>
          </div>
        </div>

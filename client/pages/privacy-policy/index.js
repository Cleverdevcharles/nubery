...
const Privacy = () => {
  return (
    <div className="p-3 my-3 mx-8">
        <Head>
        <title>Nubery || Privacy Policy</title>
      </Head>
      <h1 className="text-center font-bold text-6xl">Privacy Policy</h1>
      <p className="text-center italic">Last updated: November 09, 2022</p>
      <p >
      ...
      <h1 className="mt-3 text-2xl">Interpretation and Definitions</h1>
      <h2 className="mt-1 text-xl">Interpretation</h2>
      <p>
      ...
      <ul className="list-disc">
        ...
        <li>
          <p className="mt-1">
            ...
            this Agreement) refers to Nubery.
          </p>
        </li>
        <li>
          <p className="mt-1">
        ...
        <li>
          <p className="mt-1">
            <strong>Website</strong> refers to Nubery, accessible from{" "}
            <a
              href="https://nubery.net"
      ...
      <h1 className="mt-5 text-2xl">Collecting and Using Your Personal Data</h1>
      <h2 className="mt-1 text-xl">Types of Data Collected</h2>
      <h3 className="mt-1 font-semibold">Personal Data</h3>
      <p className="mt-2">
      ...
      <h3 className="mt-1 font-semibold">Usage Data</h3>
      ...
      <h3 className="mt-2 font-semibold">Tracking Technologies and Cookies</h3>
      <p className="mt-2">
      ...
      <h2 className="mt-2 font-bold">Use of Your Personal Data</h2>
      ...
      <h2 className="mt-3 font-bold">Retention of Your Personal Data</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-3 font-bold">Transfer of Your Personal Data</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-3 font-bold">Delete Your Personal Data</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-3 font-bold">Disclosure of Your Personal Data</h2>
      <h3 className="mt-2 font-semibold">Business Transactions</h3>
      <p className="mt-2 ">
      ...
      <h3 className="mt-2 font-semibold">Law enforcement</h3>
      <p className="mt-2">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="mt-2 font-semibold">Other legal requirements</h3>
      <p className="mt-2">
      ...
      <h2 className="mt-3 font-bold">Security of Your Personal Data</h2>
      <p className="mt-2">
      ...
      <h1 className="mt-2 font-bold ">Children's Privacy</h1>
      <p>
      ...
      <h1 className="mt-2 font-bold">Links to Other Websites</h1>
      <p className="mt-2">
      ...
      <h1 className="mt-2 font-bold">Changes to this Privacy Policy</h1>
      <p className="mt-2">
      ...
      <h1 className="mt-2 font-semibold">Contact Us</h1>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>By email: support@nubery.net</li>
      </ul>
    </div>
  );
};

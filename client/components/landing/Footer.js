...
const Footer = () => {
  ...
  return (
    <div className="footer-section" style={{position: "relative"}}>
          ...
          <div className="row">
            <div className="col-sm-6  d-flex align-items-center">
              <div className="copywright-text">
                <p>&copy; 2022 - Nubery. All rights reserved</p>
              </div>
            </div>
          </div>
        </div>
